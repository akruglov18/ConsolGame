...
public:
    ...
    std::string string_type() const override { return "Pants_green"; }
};

class Pants_plate : public Pants {
public:
    Pants_plate(const sf::Vector2f& pos);
    std::string string_type() const override { return "Pants_plate"; }
};

class Pants_robe_skirt : public Pants {
public:
    Pants_robe_skirt(const sf::Vector2f& pos);
    std::string string_type() const override { return "Pants_robe_skirt"; }
};
